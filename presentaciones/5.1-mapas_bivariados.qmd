...
#| echo: true
#| 
stl_race_income$alpha = stl_race_income$x + stl_race_income$y
stl_race_income$color = atan(stl_race_income$y/stl_race_income$x)
...
map = ggplot()+
  #geom_sf(data=wrld)+
  geom_sf(data = stl_race_income, aes(fill = color, alpha = alpha), show.legend = FALSE)+
  scale_fill_viridis_c()+
